...
var tcar_wheel_fz = 54;
var tcar_wheel_rx = -34;
var tcar_wheel_ry = 20;
var tcar_wheel_rz = 54;
...
// add 4 wheels	
	...
	my.car_wheelFL = car_wheelcreate(my,vector(my.car_wheel_fx,-my.car_wheel_fy,my.car_wheel_fz));
	my.car_wheelFR = car_wheelcreate(my,vector(my.car_wheel_fx,my.car_wheel_fy,my.car_wheel_fz));
	my.car_wheelRL = car_wheelcreate(my,vector(my.car_wheel_rx,-my.car_wheel_ry,my.car_wheel_rz));
	my.car_wheelRR = car_wheelcreate(my,vector(my.car_wheel_rx,my.car_wheel_ry,my.car_wheel_rz));
